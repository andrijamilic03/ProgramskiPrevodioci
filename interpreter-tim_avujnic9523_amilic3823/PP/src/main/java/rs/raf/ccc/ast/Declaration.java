...
public class Declaration extends Statement {
    private String name;
    private rs.raf.ccc.ast.Type type;       // Custom enum or class Type (int, bool)
    ...
    public Declaration(Location location, rs.raf.ccc.ast.Type type, String name, Expression value) {
        super(location);
        this.type = type;
        this.name = name;
        this.value = value;
